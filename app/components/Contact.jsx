...
const Contact = () => {
  return (
    <>
      <div className="md:ml-24 mt-20 text-white py-6 mx-6">
        <h1 className="text-3xl mb-4">Contact Us</h1>
        <div className="flex w-full md:justify-between gap-8 flex-col md:flex-row ">
        ...
        <div className="flex md:justify-between flex-col">
          ...
          <div className="md:mr-24 flex justify-center">
